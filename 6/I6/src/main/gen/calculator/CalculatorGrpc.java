...
public final class CalculatorGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<arithmetic.ArithmeticOpArguments,
      arithmetic.ArithmeticOpResult> getAddMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Add",
      requestType = arithmetic.ArithmeticOpArguments.class,
      responseType = arithmetic.ArithmeticOpResult.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<arithmetic.ArithmeticOpArguments,
      arithmetic.ArithmeticOpResult> getAddMethod() {
    io.grpc.MethodDescriptor<arithmetic.ArithmeticOpArguments, arithmetic.ArithmeticOpResult> getAddMethod;
      ...
      synchronized (CalculatorGrpc.class) {
        if ((getAddMethod = CalculatorGrpc.getAddMethod) == null) {
          CalculatorGrpc.getAddMethod = getAddMethod =
              io.grpc.MethodDescriptor.<arithmetic.ArithmeticOpArguments, arithmetic.ArithmeticOpResult>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Add"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  arithmetic.ArithmeticOpArguments.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  arithmetic.ArithmeticOpResult.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<arithmetic.ArithmeticOpArguments,
      arithmetic.ArithmeticOpResult> getSubtractMethod;
  ...
  public static io.grpc.MethodDescriptor<arithmetic.ArithmeticOpArguments,
      arithmetic.ArithmeticOpResult> getSubtractMethod() {
    io.grpc.MethodDescriptor<arithmetic.ArithmeticOpArguments, arithmetic.ArithmeticOpResult> getSubtractMethod;
  ...
  public static abstract class CalculatorImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void add(arithmetic.ArithmeticOpArguments request,
        io.grpc.stub.StreamObserver<arithmetic.ArithmeticOpResult> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getAddMethod(), responseObserver);
    }

    /**
     */
    public void subtract(arithmetic.ArithmeticOpArguments request,
        io.grpc.stub.StreamObserver<arithmetic.ArithmeticOpResult> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                arithmetic.ArithmeticOpArguments,
  ...
  public static final class CalculatorBlockingStub extends io.grpc.stub.AbstractBlockingStub<CalculatorBlockingStub> {
    ...
    /**
     */
    public arithmetic.ArithmeticOpResult add(arithmetic.ArithmeticOpArguments request) {
    ...
    /**
     */
    public arithmetic.ArithmeticOpResult subtract(arithmetic.ArithmeticOpArguments request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CalculatorFutureStub extends io.grpc.stub.AbstractFutureStub<CalculatorFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<arithmetic.ArithmeticOpResult> add(
        arithmetic.ArithmeticOpArguments request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<arithmetic.ArithmeticOpResult> subtract(
        arithmetic.ArithmeticOpArguments request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ADD:
          serviceImpl.add((arithmetic.ArithmeticOpArguments) request,
              (io.grpc.stub.StreamObserver<arithmetic.ArithmeticOpResult>) responseObserver);
          break;
        case METHODID_SUBTRACT:
          serviceImpl.subtract((arithmetic.ArithmeticOpArguments) request,
              (io.grpc.stub.StreamObserver<arithmetic.ArithmeticOpResult>) responseObserver);
          break;
        default:
