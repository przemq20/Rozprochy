...
{
    default void disconnect(Account account)
    {
        disconnect(account, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void disconnect(Account account, java.util.Map<String, String> context)
    {
        _iceI_disconnectAsync(account, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> disconnectAsync(Account account)
    {
        return _iceI_disconnectAsync(account, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> disconnectAsync(Account account, java.util.Map<String, String> context)
    {
        return _iceI_disconnectAsync(account, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_disconnectAsync(Account iceP_account, java.util.Map<String, String> context, boolean sync)
    {
