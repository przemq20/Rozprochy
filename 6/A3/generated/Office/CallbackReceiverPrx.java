...
{
    default void callback(Task task)
    {
        callback(task, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void callback(Task task, java.util.Map<String, String> context)
    {
        _iceI_callbackAsync(task, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> callbackAsync(Task task)
    {
        return _iceI_callbackAsync(task, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> callbackAsync(Task task, java.util.Map<String, String> context)
    {
        return _iceI_callbackAsync(task, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_callbackAsync(Task iceP_task, java.util.Map<String, String> context, boolean sync)
    {
